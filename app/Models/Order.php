...
class Order extends Model
{
    ...
    protected $fillable = [ 'order_number', 'sub_total', 'total_amount', 'quantity', 'transfer_evidence', 'cod', 'status', 'user_id', 'ongkir', 'city' , 'email', 'phone', 'address', 'post_code', 'first_name','last_name' , 'cancel_reason'];
