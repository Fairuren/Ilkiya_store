                                            ...
                                            <div class="product-img">
                                                <a href="{{ route('product-detail', $product->slug) }}">
                                                    @php
                                                        ...
                                                        // dd($photo);
                                                    @endphp
                                                    <img style="min-height: 300px; max-height : 50px;" class="default-img"
                                                        src="{{ asset('/storage/images/' . $photo[0]) }}"
                                                        alt="{{ $photo[0] }}">
                                                    <img class="hover-img" style="min-height : 300px ; max-height : 50px; "
                                                        src="{{ asset('/storage/images/' . $photo[0]) }}"
                                                        alt="{{ $photo[0] }}">
                                                    @if ($product->stock <= 0)
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <div class="list-image overlay">
                                                @php
                                                    $photo = explode(',', $product->image);
                                                @endphp
                                                <img style="min-height : 200px ; max-height : 50px; "
                                                    src="{{ asset('/storage/images/' . $photo[0]) }}"
                                                    alt="{{ $photo[0] }}">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12 no-padding">
                                            <div class="content">
                                                ...
                                                <p class="price with-discount">Rp.
