                                        ...
                                        <tr>
                                            ...
                                            <td class="product-des" data-title="Description">
                                                <p class="product-name"><a
                                                        href="{{ route('product-detail', $cart->book['slug']) }}"
                                                        target="_blank">{{ $cart->book['name'] }}</a></p>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            There are no any carts available. <a href="{{ route('product-grids') }}"
                                                style="color:blue;">Lanjut Belanja</a>
                            ...
                            <div class="col-lg-4 col-md-7 col-12">
                                <div class="right">
                                    <ul>
                                        ...
                                        @endphp
                                        @if (session()->has('coupon'))
                                            <li class="last" id="order_total_price">Bayar <span>Rp.
