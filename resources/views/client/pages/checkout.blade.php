                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input readonly style="border : 1px solid black;" type="text" name="first_name"
                                            placeholder="Isi Nama Depan" value="{{ old('name', auth()->user()->name) }}">
                                        @error('first_name')
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input readonly style="border : 1px solid black;" type="text" name="last_name"
                                            placeholder="Isi Nama Depan" value="{{ old('lastName', auth()->user()->lastName) }}">
                                        @error('last_name')
                                            <span class='text-danger'>{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input readonly style="border : 1px solid black;" type="email" name="email"
                                            placeholder="Isi Email Anda" value="{{ old('email', auth()->user()->email) }}">
                                        @error('email')
                                            <span class='text-danger'>{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input readonly style="border : 1px solid black;" type="number" name="phone"
                                            placeholder="ISi Nomor Telepon Anda" required value="{{ old('phone', auth()->user()->phone) }}">
                                        @error('phone')
                                            <span class='text-danger'>{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input readonly style="border : 1px solid black;" type="text" name="address"
                                            placeholder="Isi Alamat Anda" value="{{ old('address', auth()->user()->address) }}">
                                        @error('address')
                                            <span class='text-danger'>{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input style="border : 1px solid black;" type="text" name="post_code"
                                            placeholder="Isi Kode Pos" value="{{ old('postalCode', auth()->user()->postalCode) }}">
                                        @error('post_code')
                                            <span class='text-danger'>{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="checkbox">
                                        ...
                                        <form-group>
                                            ...
                                            <div style="margin-top: 12px" class="form-check">
                                                <input style="margin-left : 2px"  class="form-check-input" type="checkbox" id="check1" name="cod" value={{true}}>
                                                <label style="font-weight: semibold;" class="form-check-label">Centang Untuk Pembayaran COD</label>
                                              </div>
                                        </form-group>
