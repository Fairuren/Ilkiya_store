                            ...
                            <div class="single-widget recent-post">
                                ...
                                @foreach ($recent_products as $product)
                                    ...
                                    <div class="single-post first">
                                        <div class="image">
                                            <img class="default-img" src="{{ asset('/storage/images/' . $photo[0]) }}"
                                                alt="{{ $photo[0] }}">
                    ...
                    <div class="col-lg-9 col-md-8 col-12">
                                        ...
                                        <div class="single-shorter">
                                            ...
                                            <select class='sortBy' name='sortBy' onchange="this.form.submit();">
                                                ...
                                                <option value="category" @if (!empty($_GET['sortBy']) && $_GET['sortBy'] == 'category') selected @endif>
                                                    Kategori</option>
                                                <option value="publisher" @if (!empty($_GET['sortBy']) && $_GET['sortBy'] == 'publisher') selected @endif>
                                                    Penerbit</option>
                                            </select>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            @if (count($products) > 0)
                                            ...
                                            <div class="product-img">
                                                ...
                                                <div class="button-head">
                                                    ...
                                                    <div class="product-action-2">
                                                        <a title="Add to cart"
                                                            href="{{ route('add-to-cart', $product->slug) }}">Tambahkan
                                                            ke Keranjang</a>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                @endforeach
                            @else
                                <h4 style="margin:100px auto;">Tidak ada Buku.</h4>
                            @endif
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                    <div class="quickview-content">
                                        ...
                                        @php
                                            $after_discount = $product->price - ($product->price * $product->discount) / 100;
                                        @endphp
                                        <h3><small><del class="text-muted">Rp.
                                                    {{ number_format($product->price, 2) }}</del></small> Rp.
