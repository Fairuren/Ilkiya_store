    ...
    <div class="content">
        <div class="container-fluid">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card card-stats">
                        <div style="padding : 10px;">
                            ...
                            <h3 class="card-title">Rp. {{ number_format(\App\Models\Order::totalIncome(), 2) }} </h3>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card card-stats">
                        <div style="padding : 10px;">
                            ...
                            <h3 class="card-title">Rp. {{ number_format(\App\Models\Order::totalIncomeToday(), 2) }}
                            </h3>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card card-stats">
                        <div style="padding : 10px;">
                            ...
                            <h3 class="card-title">Rp. {{ number_format(\App\Models\Order::totalIncomeThisMonth(), 2) }}
                            </h3>
                        </div>
                        <div class="card-footer">
                            <div class="stats">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card card-stats">
                        <div style="padding : 10px;">
                            ...
                            <h3 class="card-title">Rp. {{ number_format(\App\Models\Order::totalIncomeThisYear(), 2) }}
                        </div>
                        <div class="card-footer">
                            <div class="stats">
            ...
            <div style="padding: 12px;">
                ...
                <form class="float-right" method="post" target="_blank" action="{{ route('chart_income.pdf') }}">
                    {{ csrf_field() }}
                    <button type="submit" class="btn btn-primary btn-sm"><i class="material-icons">download</i> Unduh
                        PDF</button>
                </form>
            </div>
