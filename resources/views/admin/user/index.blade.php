            ...
            <div class="card-header py-3">
                ...
                <div class="d-flex float-right">
                    ...
                    <a href="{{ route('user.create') }}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip"
                        data-placement="bottom" title="Add User"> <i class="material-icons">add</i> Add users</a>
                </div>
            </div>
            <div class="card-body">
                                        ...
                                        <td>
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <form method="POST" action="{{ route('user.destroy', [$users->id]) }}">
                                                    @csrf
                                                    @method('delete')
                                                    <button c class="btn btn-danger btn-sm btn-round btn-just-icon"
                                                        data-id={{ $users->id }} data-toggle="tooltip"
