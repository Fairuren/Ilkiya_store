        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
                ...
                <form style="width: 28rem; display : flex; justify-content : center ; align-items : center;"
                    class="float-right" method="post" target="_blank" action="{{ route('allorder.pdf') }}">
                    {{ csrf_field() }}
            ...
            <div class="card-body">
                <div class="table-responsive">
                    @if (count($orders) > 0)
                        <table class="table table-fixed" id="product-dataTable" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    <th>S.N.</th>
                                    <th>Order No.</th>
                                ...
                                @foreach ($orders as $order)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                            <span class="badge badge-primary">Non COD</span>
                                            @endif
                                        </td>
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <a href="{{ route('order.edit', $order->id) }}"
                                                    ...
                                                    data-toggle="tooltip" title="edit" data-placement="bottom"><i
                                                        class="material-icons">warning</i></a>
