          ...
          <form method="post" action="{{ route('profile.update') }}" autocomplete="off" class="form-horizontal">
            ...
            <div class="card ">
              ...
              <div class="card-body ">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('lastName') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('lastName') ? ' is-invalid' : '' }}" name="lastName" id="input-lastName" type="text" placeholder="{{ __('lastName') }}" value="{{ old('lastName', auth()->user()->lastName) }}" required="true" aria-required="true"/>
                ...
                <div class="row">
                  <label class="col-sm-2 col-form-label">{{ __('PostalCode') }}</label>
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('postalCode') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('postalCode') ? ' is-invalid' : '' }}" name="postalCode" id="input-postalCode" type="text" placeholder="{{ __('PostalCode') }}" value="{{ old('postalCode', auth()->user()->postalCode) }}" required />
                      @if ($errors->has('postalCode'))
                        <span id="postalCode-error" class="error text-danger" for="input-postalCode">{{ $errors->first('postalCode') }}</span>
                      @endif
                    </div>
                  </div>
                </div>
